 ...
 */
final class Version20210222195959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD trick_id INT DEFAULT NULL, DROP tricks_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD tricks_id INT NOT NULL, DROP trick_id');
