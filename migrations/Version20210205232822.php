 ...
 */
final class Version20210205232822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trick (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, difficulty INT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME DEFAULT NULL, content LONGTEXT NOT NULL, INDEX IDX_D8F0A91EC54C8C93 (type_id), INDEX IDX_D8F0A91EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
